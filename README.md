...
### コネクトフリー株式会社 (2019/2 - ) Senior Vice President of Embedded Software Development Group
...
Zen言語を使用した組込みのベアメタルランタイムをスクラッチから開発中

- ホストOS上でもマイコン上でも同じアプリケーションが動作する言語ランタイム/標準ライブラリの開発
  - Zen言語のコンパイル時計算機能を活用したマルチプラットフォーム対応
  - Zen言語のasync機能を活用したマルチタスク対応
- 10名/リーダー
...
Zen言語 (主に標準ライブラリと一部のコンパイラ機能) の開発を担当

- Zen言語の改善、バグフィックス、ドキュメンテーション
...
- [マイコン・組み込み開発のリスク認識 入門](https://seminar.cqpub.co.jp/ccm/ES19-0156)
